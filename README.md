...
| [`crates/kernel`](crates/kernel) | Supported native facade | Session/part lifecycle, opaque IDs/views, block/cylinder/profile-extrusion construction, rigid copy, certified Plane/Cylinder section graphs, failure-atomic block/block, axial, convex bounded-arc, disconnected planar-minus-cylinder, and multi-portal cap-retaining mixed Unite/cylinder-left Subtract, checking, tessellation, and typed X_T import/export without raw topology leakage. |
