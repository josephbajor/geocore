...
- M4 has started in `kops` with bounded line/line, 3D line/circle, 3D
  ...
  circle/plane, ellipse/plane, circle/cylinder, circle/cone, and circle/sphere.
  General NURBS/procedural curve/curve cases, broader curve/surface,
  surface/surface intersections, and imprinting remain.
