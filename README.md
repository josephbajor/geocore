...
| [`crates/kops`](crates/kops) | L3 operations | M4 intersection foundation: parameter-rich curve/curve results and deterministic bounded line/line intersections, including coincident overlaps |
...
- M4 has started in `kops` with bounded line/line intersections. General
  curve/curve, curve/surface, surface/surface intersections, and imprinting remain.
