...
| [`crates/kernel`](crates/kernel) | Supported native facade | Session/part lifecycle, opaque semantic IDs and views, block/profile-extrusion construction, rigid copy, certified planar block Booleans, checking, tessellation, and typed X_T import/export without raw topology leakage. |
