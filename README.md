...
| [`crates/kernel`](crates/kernel) | Supported native facade | Session/part lifecycle, opaque semantic IDs and views, block/cylinder/profile-extrusion construction, rigid copy, certified block/block and first axial block/cylinder Booleans, checking, tessellation, and typed X_T import/export without raw topology leakage. |
