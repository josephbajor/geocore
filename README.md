...
| [`crates/kernel`](crates/kernel) | Supported native facade | Session/part lifecycle, opaque semantic IDs and views, block/cylinder/profile-extrusion construction, rigid copy, certified block/block plus first axial and zero-cut whole-source block/cylinder Booleans, checking, tessellation, and typed X_T import/export without raw topology leakage. |
