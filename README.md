...
| [`crates/kernel`](crates/kernel) | Supported native facade | Session/part lifecycle, opaque IDs/views, block/cylinder/profile-extrusion construction, rigid copy, certified section graphs with Plane/Cylinder rings, bounded arcs, and topology-clipped transverse ruling fragments, block/block plus axial curved Booleans, checking, tessellation, and typed X_T import/export without raw topology leakage. |
