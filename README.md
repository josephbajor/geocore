...
- M2.5 is in progress and remains the next architecture gate. The per-fin pcurve storage,
  2D evaluators, analytic primitive authoring, and local incidence checking slice has
  landed. X_T/Euler migration, pcurve-driven tessellation, face domains/tolerances, a
  procedural geometry graph, transactions/rollback, deterministic lineage journals,
