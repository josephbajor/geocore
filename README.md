...
| [`crates/kops`](crates/kops) | L3 operations | M4 intersection foundation: parameter-rich curve/curve results plus deterministic bounded line/line and 3D line/circle intersections |
...
- M4 has started in `kops` with bounded line/line and 3D line/circle intersections.
  Other analytic curve/curve cases, curve/surface, surface/surface intersections,
