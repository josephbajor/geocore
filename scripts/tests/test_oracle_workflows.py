...
class OracleWorkflowTests(unittest.TestCase):
    ...
    def test_licensed_host_workflow_is_manual_serial_and_capped(self):
        ...
        self.assertIn("corner-contact", workflow)
        self.assertIn("oracle_loop.py probe corner-contact-subtract", workflow)
        self.assertIn("corner-contact-complete.txt", workflow)
