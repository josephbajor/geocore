...
Its twenty-three payloads cover connected block/block unite/subtract/intersect, both
...
Subtractions, a plate with three sequential through cuts, its enlarged-hole result, overlapping-hole result, and separated/crossing follow-up cuts on that result.
