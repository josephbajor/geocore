...
is certified by the 2026-07-21 Onshape rows; the current twenty-payload
...
Its twenty payloads cover connected block/block unite/subtract/intersect, both
...
Subtractions, a plate with three sequential through cuts, and its enlarged-hole result.
...
five added payloads have not yet received licensed-host evidence. Later writer-byte
