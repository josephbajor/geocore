...
linear-resolution consolidation.
This does not migrate the remaining conic/primitive quartics, generic
higher-degree roots, arbitrary tilted semantic-axis relations that are not
exact coefficient identities, stronger exact axis-distance exclusion under
