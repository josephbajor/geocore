...
Composed subtraction supports separated, nested, and transverse overlapping through cuts with Full proof, independent volume, preserved holes, deterministic X_T, and budget rollback. Evidence: `composed_cuts_split_crossing_holes_with_full_proof_and_independent_volume`, `composed_crossing_cut_budget_denial_is_failure_atomic`. Open: later cuts on bounded-arc results, exact contact, tilted cuts, broader composition, and licensed replay of the three composed-plate payloads.
