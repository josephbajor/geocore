...
Certified transverse and proper boundary-returning annulus traces, exact nested line-cycle planar cells, and disk cells now share finite source-arc planning/materialization; a count-independent chord-portal theorem Full-certifies cap-crossing Unite and block-minus-cylinder at 9F/18E/12V, while Intersect and cylinder-minus-block commit at 4F/6E/4V across both rigid frames/orders with literal-derived volume, deterministic X_T, and Fast self-import. Public `body_properties` returns outward volume, centroid, area, and centroidal inertia for Full-valid exact Plane/Cylinder solids. Public `body_distance` encloses whole-material minimum distance from finite face-domain support projections and a retained topology-owned feasible witness. Public `body_clash` classifies a finite nonnegative clearance as Clear, Clashing, or Indeterminate from those endpoints in the same scope; Clashing proves threshold violation, not overlap, and a zero lower bound alone never decides. Primitive, rigid, containment, cavity, cap-crossing, refusal, determinism, and exact N/N-1 evidence are green. The sixteen-payload bundle is stale pending one licensed-host replay. Exact-parallel/antiparallel strict-secant Cylinder/Cylinder graph ruling proof is landed; public Section normalizes authored boundary orders onto one certified common axial coordinate and closes strict positive overlaps with two uniquely owned physical ends. Public partial-overlap Intersect Full-commits at 4F/6E/4V, both ordered Subtract meanings at 5F/7E/4V, and Unite at 6F/8E/4V through alternating periodic graph authority plus structural cap-reaching and two-host axial-chain shell theorems. The world/oblique, axis-direction, order, and repeat matrix has independent analytic properties, direction-local deterministic X_T/Fast self-import, source retention, rollback, and exact realization/property/shell N/N-1 refusal; unequal radii and asymmetric tails validate general representation authority. Strict nesting shares that matrix and exact work contracts. Tangent, internal, coincident, and skew relations remain typed graph gaps. Proof-fed coincident planar-cap ownership now Full-commits equal-radius equal-height and one-shared-end parallel/antiparallel Cylinder/Cylinder Intersect, Unite, and both ordered Subtract meanings at 4F/6E/4V or 5F/7E/4V across world/oblique direction/order/repeat, with independent properties, journal lineage, deterministic X_T/Fast self-import, retained sources, rollback, and exact realization/property/shell N/N-1 refusal. Strict axial separation binds all four live cap/ring supports and clears exact dyadic or Full-incidence envelopes before exterior radial evidence. Public Intersect is mutation-free ProvenEmpty, Unite Full-commits canonical source copies, and ordered Subtract Full-commits the minuend copy across world/oblique direction/order/repeat and secant/internal/tangent/coincident radial supports, with independent analytic properties, complete lineage, deterministic X_T/Fast self-import, retained sources, rollback, exact 64/63 relation work, and exact 52/26 realization-work refusal. Next: certify exact zero axial-gap cap contact for ProvenEmpty Intersect and minuend-copy Subtract; defer Unite until shared-interface removal is proof-owned.
