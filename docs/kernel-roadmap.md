...
dot/cross/distance/subtraction overflow, or overflow-safe `Line2d` and
`Circle2d` direction normalization with an explicit zero-only versus
linear-resolution-floor policy.
