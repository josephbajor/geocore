...
parallel cylinder/cylinder rulings, plane/torus latitude and meridian circles,
and sphere/sphere closed form branches over finite windows, including tangent
point contacts, singular apex contacts, ruling branches, and branch clipping.
