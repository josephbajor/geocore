...
Parallel-cylinder Section certifies strict positive overlaps and exterior radial separation; at exact axial contact, strict radial secancy retains two proof-joined bounded cap arcs with dual source-ring root identity while tangent/internal/coincident/skew remain typed graph gaps. Public regularized CSG Full-commits strict overlaps, coincident caps, and strict separation across exact world/oblique axis-direction/order/repeat matrices. Exact zero-gap cap contact returns mutation-free ProvenEmpty Intersect and an ordered whole-minuend Subtract copy; Unite now Full-commits strict internal disk containment as 5F/4E/0V and exact coincident support as 3F/2E/0V, with independent analytic properties, Full reports, complete DerivedFrom/Merge lineage, deterministic X_T/Fast self-import, rollback, exact 64/63 relation work, 1092/1091 internal or 420/419 coincident realization refusal, and 1188/1187 internal theorem refusal. Next: Full-commit strict-secant contact Unite from the published dual-root arcs through shared-cap arrangement and split-ring closure; tangency remains boundary-only.
