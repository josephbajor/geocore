...
circle/cylinder and circle/sphere over finite surface windows, including
contained line-on-plane, conic-on-plane, circle-on-cylinder, circle-on-sphere,
and line-on-ruling intervals, cone apex singular contacts, and torus quartic
