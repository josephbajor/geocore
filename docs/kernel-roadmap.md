...
Parallel-cylinder Section certifies strict positive overlaps and exterior radial separation; at exact axial contact, strict radial secancy retains two proof-joined bounded cap arcs with dual source-ring root identity while tangent/internal/coincident and intersecting skew pairs remain typed graph gaps. Exact nonparallel negative-discriminant misses now complete without branches through dual-frame cyclic/factor authority and retain public source-face provenance. Public regularized CSG Full-commits strict overlaps, coincident caps, strict separation, exact zero-gap contact, exact external radial tangency, exact common-cylinder support, and the manifold subset of exact unequal-radius internal radial tangency through positive axial overlap. Common support uses one certified four-endpoint total preorder and open-cell sweep for crossing, nesting, shared-end, and equal intervals; all three operations atomically return zero, one, or two canonical 3F/2E/0V bands with exact endpoint Merge and ordered cross-body Face Split where proved. Internal tangency retains directed containment and the same preorder: Intersect returns the contained-radius overlap band or whole contained copy; contained-minus-containing returns regularized empty or one/two contained-radius bands; Unite returns a whole containing copy for zero contained-only tails, one compact 5F/4E/1V tangent shoulder for one tail, or a canonical 7F/6E/2V three-band/two-shoulder chain for two tails. Each shoulder's bounded full-period rings share one exact tangent vertex in one two-fin planar loop; the chain vertices are distinct. Complete ordered lineage, deterministic reports, independent properties, X_T/Fast self-import, rollback, and exact 64/63 relation, 420/419 per-band, 1092/1091 shoulder and 2052/2051 chain realization, 1113/1112 shoulder and 1860/1859 chain proof, 26/25 source-copy, 3953/3952 band-property, 7881/7880 shoulder-property, and 11809/11808 chain-property evidence hold across the rigid-frame/order/axis matrix. Evidence: `exact_common_support_executes_the_complete_twenty_row_interval_table`, `exact_internal_tangency_executes_the_regularized_axial_semantic_table`, `exact_internal_tangency_is_deterministic_across_frames_orders_and_axis_directions`, `internal_tangency_realization_work_has_exact_atomic_frontiers`, `tangent_chain_properties_have_exact_frontier_and_independent_union_oracle`, and `rebuilt_internal_tangent_results_have_stable_xt_and_fast_self_import_twice`. One-ULP neighbors, loose tolerance, and unsafe arithmetic fail closed. Containing-minus-contained remains a pinched non-manifold refusal. Next: construct certified finite-window two-sheet skew Cylinder/Cylinder carriers and paired pcurves; keep the pinched difference typed non-manifold.
