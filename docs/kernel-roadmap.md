...
circle/cylinder, circle/cone, circle/sphere, ellipse/sphere, and
ellipse/cylinder over finite
surface windows, including contained line-on-plane, conic-on-plane,
circle-on-cylinder, ellipse-on-cylinder, circle-on-cone, circle-on-sphere, and
