...
Parallel-cylinder Section certifies strict positive overlaps and exterior radial separation; at exact axial contact, strict radial secancy retains two proof-joined bounded cap arcs with dual source-ring root identity while tangent/internal/coincident/skew remain typed graph gaps. Public regularized CSG Full-commits strict overlaps, coincident caps, and strict separation. Exact zero-gap cap contact returns mutation-free ProvenEmpty Intersect and an ordered whole-minuend Subtract copy; Unite Full-commits strict internal disk containment as 5F/4E/0V, exact coincident support as 3F/2E/0V, equal/unequal-radius strict secancy as 6F/6E/2V, and exact external tangency as two atomically copied 3F/2E/0V bodies across world/Pythagorean-tilted axis-direction/order/repeat matrices. The contact slices retain properties, Full reports, complete lineage, deterministic X_T/Fast self-import, rollback, exact 64/63 relation work, 52/51 tangent-copy work, 1785/1784 strict-secant realization refusal, and 1593/1592 strict-secant theorem refusal. One-ULP and rounded all-nonzero oblique near cases remain boundary refusals. Next: certify exact external radial tangency with positive axial overlap for the same source-copy set semantics; internal tangency remains a typed gap.
