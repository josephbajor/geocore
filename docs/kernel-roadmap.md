...
circle/cylinder, circle/cone, circle/sphere, and ellipse/sphere over finite
surface windows, including contained line-on-plane, conic-on-plane,
circle-on-cylinder, circle-on-cone, circle-on-sphere, and line-on-ruling
intervals, cone apex singular contacts, and torus quartic contacts. General
NURBS/procedural curve/curve, broader curve/surface, and SSI remain.
