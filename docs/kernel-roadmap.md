...
Parallel-cylinder Section certifies strict positive overlaps and exterior radial separation; at exact axial contact, strict radial secancy retains two proof-joined bounded cap arcs with dual source-ring root identity while tangent/internal/coincident/skew remain typed graph gaps. Public regularized CSG Full-commits strict overlaps, coincident caps, strict separation, and exact external radial tangency through positive axial overlap. Exact zero-gap cap contact returns mutation-free ProvenEmpty Intersect and an ordered whole-minuend Subtract copy; Unite Full-commits strict internal disk containment as 5F/4E/0V, exact coincident support as 3F/2E/0V, equal/unequal-radius strict secancy as 6F/6E/2V, and exact external tangency as two atomically copied 3F/2E/0V bodies. Positive-overlap tangency retains empty Intersect, ordered minuend-copy Subtract, and two-copy Unite across equal/unequal radii; nested, partial, and shared-end intervals; world/translated-Pythagorean frames; all axis-direction pairs; swaps; and repeats. The slices retain properties, Full reports, complete lineage, deterministic X_T/Fast self-import, rollback, exact 64/63 relation work, 52/51 or 26/25 copy work, 1785/1784 strict-secant realization refusal, and 1593/1592 strict-secant theorem refusal. Division-free exact support proof checks both stored axes and an error-free representable radius sum. One-ULP inward, internal-tangent, unsafe, unrepresentable-sum, and rounded all-nonzero oblique cases remain boundary refusals. Analytic-shell assembly now validates ordered Face Split groups across components and endpoint-free Edge Merge sources before allocation, then records them atomically after deterministic realization. Next: exact common-cylinder-support interval CSG through one generic four-endpoint axial cell sweep using that contract; internal tangency and skew SSI remain typed gaps.
