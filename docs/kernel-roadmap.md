...
circle/cylinder, circle/cone, and circle/sphere over finite surface windows,
including contained line-on-plane, conic-on-plane, circle-on-cylinder,
circle-on-cone, circle-on-sphere, and line-on-ruling intervals, cone apex
