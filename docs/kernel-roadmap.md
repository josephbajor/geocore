...
contacts, ruling branches, and branch clipping. SSI branch result geometry now
supports exact NURBS curves in addition to line/circle/ellipse branches, clearing
the result-contract path for broader conic and marched/subdivision SSI curves.
