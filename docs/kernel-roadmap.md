...
NURBS/plane, and initial fixed-grid NURBS/sphere and NURBS/cylinder marching,
including contained curve overlaps, cone apex singular contacts, and torus
quartic contacts. General
...
plane/sphere/cylinder/cone/torus/NURBS-surface marching over finite windows, including
