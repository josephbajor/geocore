...
Parallel-cylinder Section certifies strict positive overlaps and exterior radial separation; at exact axial contact, strict radial secancy retains two proof-joined bounded cap arcs with dual source-ring root identity while tangent/internal/coincident/skew remain typed graph gaps. Public regularized CSG Full-commits strict overlaps, coincident caps, and strict separation across exact world/oblique axis-direction/order/repeat matrices. Exact zero-gap cap contact returns mutation-free ProvenEmpty Intersect and an ordered whole-minuend Subtract copy; Unite Full-commits strict internal disk containment as 5F/4E/0V, exact coincident support as 3F/2E/0V, and equal/unequal-radius strict secancy as 6F/6E/2V. The contact slices retain independent analytic properties, Full reports, complete DerivedFrom/Merge/Split lineage, deterministic X_T/Fast self-import, rollback, exact 64/63 relation work, 1785/1784 strict-secant realization refusal, and 1593/1592 strict-secant theorem refusal. Next: regularize exact external-tangent contact Unite as an atomic two-component result without inventing a point-connected manifold shell.
