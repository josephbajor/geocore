...
The `standard` lane adds every one of the 78 current non-corpus integration
...
references, and the exact 92/78/14 total/standard/corpus counts before every
...
The exact parallel-cylinder radial-relation checkpoint added one ordinary
non-corpus proof target, advancing the current reviewed inventory to 92/78.
