...
now uses the exact v11 corpus profile. V5 remains fixed at
...
parity. Seven-sample dual-offset record 3615 is the next stable typed
`xt.read.intersection-surface-family` boundary.
...
3. **Resume algorithm/API expansion behind the completed gates.** The first facade
   ...
   independent original-source proofs, and historical v1-v9 parity. The next
   v11 normalizes only null or finite-numeric zero-multiplicity nonperiodic
   ...
   historical v1-v10 parity. Seven-sample dual-offset record 3615 is the next
   typed surface-family boundary. Half-null pairs and NURBS/Offset-NURBS
