...
Read the ordered queue below literally. At this handoff, the first unclosed
foundation obligation is the facade-owned replacement for public body
tessellation in item 1. Item 2 follows with the measured representation/trim
matrix needed before any finite `bounded_v1` tessellation preset is proposed.
Once those adoption gates are closed, item 3 has three bounded, parallel-ready
