...
now uses the exact v13 corpus profile. V5 remains fixed at
...
isolated `4277250` Work would request cumulative `436131945`.
...
3. **Resume algorithm/API expansion behind the completed gates.** The first facade
   ...
   `431854695/22/10` with historical v1-v12 parity, then stops before
   Plane/Offset record 3609's `436131945`-Work request. Half-null pairs,
