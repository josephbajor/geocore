...
and direct Sphere fields plus the first compatible direct-NURBS/NURBS unit-chart
arm to Offset(NURBS) or broader NURBS/NURBS fields. These legs do not silently
...
3. **Resume algorithm/API expansion behind the completed gates.** The first facade
   ...
   genuinely curved direct NURBS unit charts, in one owner scope. It retains
   ...
   compatible NURBS/NURBS fixture pins exact 14336/14335 Work with the same
   Items/Depth limits; its rounded scalar difference is discovery-only and
   outward original-control differences own complete misses. Planar or
   unaligned charts, unequal ranges or weights, Offset(Sphere), Offset(NURBS),
   and broader NURBS/NURBS remain explicit unsupported boundaries. Further fields and
