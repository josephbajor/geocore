...
collapsed, and first single-wide decomposition arms to multi-cell/two-wide or
polar unions and non-exact tangent cases; and
...
3. **Resume algorithm/API expansion behind the completed gates.** The first facade
   ...
   evidence. Multi-cell positive, two-wide, polar, and non-exact collapsed
