...
now uses the exact v4 corpus profile and stops at the next unsupported
`INTERSECTION_DATA` form.
...
3. **Resume algorithm/API expansion behind the completed gates.** The first facade
   ...
   `116413476` Work. Other null/non-finite chart data is the next typed and
   atomic boundary. The exact
