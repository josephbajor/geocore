...
The Q2 topology ladder now has 39 rows. Its prior 35 rows remain unchanged,
...
total-size behavior; full graph validation, committed-index cloning, body-order
refresh, global ordinary-commit cost, broader heterogeneous production edit
footprints, and production assembly remain explicit performance boundaries.
The complete benchmark manifest now contains 174 cases.
