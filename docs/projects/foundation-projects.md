...
four-cell path, exact connected four-cell 2×2 cycle, or exact five-cell path
grid arms to six-or-more-positive, five-cell non-path,
...
3. **Resume algorithm/API expansion behind the completed gates.** The first facade
   ...
   certified-empty siblings and sub-full-turn parents.
   ...
   A connected four-cell 2×2 cycle instead proves every internal seam owner
   simultaneously, cancels only reverse-oriented bit-exact edge pairs, and
   admits the result only when the remaining eight edges trace one unambiguous
   outer cycle. A separate one-ULP central-seam fixture remains indeterminate.
   ...
   five-cell non-path, non-exact or otherwise ambiguous multi-edge
