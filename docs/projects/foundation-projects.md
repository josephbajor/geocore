...
tolerance. Production does not reach it: the unchanged v12 traversal first
stops typed at five-sample dual-offset record 4230, roots `[3320, 773]`, chart
4231.
...
exact connected five-cell non-path grid arms to six-or-more-positive,
...
3. **Resume algorithm/API expansion behind the completed gates.** The first facade
   ...
   Depth N/N-1 rollback evidence. Production remains v12 and stops first at
   five-sample dual-offset record 4230. Half-null pairs, NURBS/Offset-NURBS
   omissions, and the five-sample family remain typed.
   ...
   certified-empty siblings, or for an exact connected four- or five-cell
   ...
   Connected four- and five-cell non-path unions instead prove every internal
   ...
   12-edge boundary. A physically coincident but bit-mismatched central-seam
   fixture remains indeterminate.
   Exact 9/8 piece-pair, 252/251 boundary-pair, and 1,008/1,007 arc ceilings
   preserve fail-closed admission. Six-or-more-positive two-wide,
