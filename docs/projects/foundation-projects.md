...
through five-sample direct-Plane/B-surface, safe-Offset(Plane)/B-surface, or
direct-Plane/Offset(B-surface) slice now retains finite positive noncanonical affine metadata on the
...
one exact adjacent cap-row pair and the exact full cap row,
...
3. **Resume algorithm/API expansion behind the completed gates.** The first facade
   ...
   Offset(Plane)/B-surface, or direct-Plane/Offset(B-surface) slice accepts two through five samples, retains
   ...
   `7170/2/10`, `14339/3/10`, `21508/4/10`, and `28677/5/10`. A record-5089
   ...
   the bounded direct-Plane/B-surface, safe-Offset(Plane)/B-surface, and direct-
   Plane/Offset(B-surface) affine slices remain typed.
   ...
   canonical bilinear planar direct-NURBS or direct analytic Plane peer normal
   to the global X, Y, or Z axis. A 7-Work, 1-Item, Depth-1
   ...
   286768/286767 Work and 40960/40959 Items. All orientations retain 10/9 Depth and 2/1 graph
   traversal;
   ...
   five-anchor region. A one-turn-shifted full-row fixture cancels both strict
   longitude seams, excludes the latitude seam, and retains one canonical
   11-anchor region. All preserve the singular-pole alias with exact
