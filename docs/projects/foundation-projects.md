...
3. **Resume algorithm/API expansion behind the completed gates.** The first facade
   ...
   two siblings certified empty, or exactly five positive children with the
   sole remaining sibling certified empty. The reviewed real L orientations are the
   ...
   duplicate-edge ambiguity, and a four-cell cycle fail closed. The five-cell
   ...
   one-ULP seam mutation or duplicate-edge ambiguity fails closed. The cap
   layouts preserve the singular-pole alias; every layout pins exact
   repeat/swap and outward residual evidence. Exact 6/5 piece, 147/146 pair,
   and 588/587 arc ceilings remain pinned. A one-ULP shared-edge mutation, the
   all-six-positive layout, and broader or non-adjacent layouts outside the
   admitted exact same-row, same-column, full-row, mixed-axis three-cell-path,
   four-positive path, and exactly-five-positive families remain indeterminate.
   A first
