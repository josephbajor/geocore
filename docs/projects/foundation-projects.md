...
now uses the exact v10 corpus profile. V5 remains fixed at
...
exact parity. The next source stops deterministically on zero-multiplicity
null-knot padding at knot set 6764.
...
3. **Resume algorithm/API expansion behind the completed gates.** The first facade
   ...
   source stops deterministically on zero-multiplicity null-knot padding at
   knot set 6764. Half-null pairs and NURBS/Offset-NURBS omissions remain typed.
