...
parity. Two-sample dual-offset record 3595, roots `[783, 773]`, is the next
stable typed `xt.read.intersection-surface-family` boundary.
...
3. **Resume algorithm/API expansion behind the completed gates.** The first facade
   ...
   is the next typed surface-family boundary. Half-null pairs and NURBS/Offset-NURBS
   omissions remain typed.
