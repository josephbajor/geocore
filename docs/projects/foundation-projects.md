...
four-cell path, or exact five-cell path grid arms to six-or-more-positive,
four- or five-cell non-path,
...
3. **Resume algorithm/API expansion behind the completed gates.** The first facade
   ...
   four- or five-cell non-path, non-exact or multi-edge
