...
direct Sphere, compatible direct-NURBS/NURBS, and the first direct
...
3. **Resume algorithm/API expansion behind the completed gates.** The first facade
   ...
   outward centered-mean-value Sphere and original-source NURBS lifts. The
   ...
   weights, Offset(Sphere), nested or varying-normal Offset(NURBS),
   Offset/Offset, and broader NURBS/NURBS remain explicit unsupported boundaries. Further fields and
