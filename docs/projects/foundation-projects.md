...
six-cell grid, exact seven-cell 2×3-block-plus-tail, and exact connected
eight-cell all-but-one-grid-cell arms to other seven- or eight-positive and
all nine-positive layouts,
...
3. **Resume algorithm/API expansion behind the completed gates.** The first facade
   ...
   shared-seam union, for the exact connected seven-cell
   2×3-block-plus-tail union with every other sibling certified empty and
   sub-full-turn parents, or for an exact connected eight-cell union whose sole
   remaining sibling certifies empty.
   ...
   Connected four- through eight-cell non-path unions instead prove every
   ...
   preserve fail-closed admission. Other seven- or eight-positive and all nine-positive two-wide,
