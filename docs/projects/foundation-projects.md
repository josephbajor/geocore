...
3. **Resume algorithm/API expansion behind the completed gates.** The first facade
   ...
   semantic transaction composes affine-map- and incidence-metadata-aware
   pcurve face split/merge, preserves exact rollback identity, and returns the
   committed facade journal; broader edit families remain. F6 splits and F4
