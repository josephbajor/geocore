...
2. **Finish hostile-input tessellation policy.** Exact per-face split/vertex/
   ...
   cylinder supplies the first broader curved-solid import measurement.
   Genuinely-curved-NURBS, more imported representations, and tighter-tolerance
   measurement remain and must precede a reviewed opt-in body
