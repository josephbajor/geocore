...
3. **Resume algorithm/API expansion behind the completed gates.** The first facade
   ...
   completion. The next algorithm slice is interval root-existence and typed
   minimizer termination, followed by overlap extent/completeness.
...
typed NURBS minimizer termination, first-class curve/curve incomplete evidence,
