...
now uses the exact v12 corpus profile. V5 remains fixed at
...
open-clamped polyline at isolated `17285120/5/10`. The unchanged v12 traversal
stops atomically at its `431854695`-Work preflight; v13 frontier admission
remains pending.
...
four-cell path, exact connected four-cell 2×2 cycle, exact five-cell path, or
exact connected five-cell non-path and six-cell grid arms to seven-or-more-positive,
disconnected five-cell,
...
3. **Resume algorithm/API expansion behind the completed gates.** The first facade
   ...
   certifies at `17285120/5/10`; production remains v12 and stops at its exact
   `431854695`-Work preflight pending a v13 frontier traversal. Half-null pairs,
   ...
   disconnected five-cell, non-exact or otherwise ambiguous multi-edge
