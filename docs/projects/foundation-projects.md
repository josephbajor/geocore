...
now uses the exact v7 corpus profile. V5 remains fixed at
...
rolling back on `INTERSECTION` 1984's 285,283,414-Work proof preflight.
...
3. **Resume algorithm/API expansion behind the completed gates.** The first facade
   ...
   proof. It rolls back atomically on `INTERSECTION` 1984's attempted
   285,283,414-Work proof preflight. Endpoints, half-null pairs, and
   NURBS/Offset-NURBS omissions remain typed.
