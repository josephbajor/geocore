...
block/block Boolean outcomes plus axial intersection and cylinder-minus-block remainder bands) are implemented;
...
- Extend the landed deterministic-X_T axial block/cylinder slice to curved union,
