...
truth-selected whole-source union/subtraction copies and both containment cavity orientations, one-ring axial cap-overlap connected union, one-ring axial block-minus-cylinder blind pockets, two-port axial through-holes, two-ring two-sided unions, support-separated exact-contact empty intersections, and certified flush axial cap-contact connected unions) are implemented;
...
- Public `body_properties` returns outward volume/centroid/area/inertia for Full-valid exact Plane/Cylinder solids. Public `body_distance` and `body_clash` retain ordered proof evidence without equating zero lower distance with interference. Strict positive-overlap parallel/antiparallel Cylinder/Cylinder Section normalizes source boundary order and owns two unique physical ends. Nested and partial-overlap Intersect, Unite, and both ordered Subtract meanings Full-commit across world/oblique axis-direction/order/repeat matrices with independent properties, direction-local deterministic X_T/Fast self-import, retained sources, rollback, and exact realization/property/shell N/N-1 refusal. Proof-fed coincident planar-cap ownership now Full-commits equal-radius equal-height and one-shared-end parallel/antiparallel Cylinder/Cylinder Intersect, Unite, and both ordered Subtract meanings at 4F/6E/4V or 5F/7E/4V across world/oblique direction/order/repeat, with independent properties, journal lineage, deterministic X_T/Fast self-import, retained sources, rollback, and exact realization/property/shell N/N-1 refusal. Strict axial separation binds all four live cap/ring supports and clears exact dyadic or Full-incidence envelopes before exterior radial evidence; Intersect is ProvenEmpty, Unite returns canonical source copies, and ordered Subtract returns the minuend copy across rigid frame/direction/order/repeat and secant/internal/tangent/coincident radial supports, with analytic properties, Full reports, complete lineage, deterministic X_T/Fast import, retained sources, rollback, and exact 64/63 relation plus 52/26 copy-work refusal. Next: certify exact zero axial-gap cap contact for ProvenEmpty Intersect and minuend-copy Subtract; defer Unite until shared-interface removal is proof-owned.
