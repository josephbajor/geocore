...
- Extend the landed cap-crossing disk/trace/planar-cell path through Unite/Subtract and add its deterministic payload to the next licensed-host batch; pure planar BSP and convex curved shortcuts retain the typed convex certificate gate.
