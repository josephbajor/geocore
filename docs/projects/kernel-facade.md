...
- Public `body_properties` retains its Full report and returns outward-certified volume, centroid, surface-area, and unit-density centroidal-inertia enclosures from exact Plane/Cylinder boundaries. Per-face oriented area preserves holes/cavities; six anchor-relative second moments yield the symmetric standard inertia tensor with primitive, oblique-covariance, cap-crossing valuation, deterministic/refusal, and exact N/N-1 evidence. Distance and clash are next; new booleans remain queued.
