...
truth-selected whole-source union/subtraction copies) are implemented;
...
- Extend the landed deterministic-X_T axial and zero-cut block/cylinder slice to cut/connected curved union,
