...
truth-selected whole-source union/subtraction copies and both containment cavity orientations, one-ring axial cap-overlap connected union, one-ring axial block-minus-cylinder blind pockets, two-port axial through-holes, two-ring two-sided unions, support-separated exact-contact empty intersections, certified flush axial cap-contact connected unions, and exact zero-gap cylinder/cylinder Intersect/Subtract) are implemented;
