...
- Public `body_properties`, `body_distance`, and `body_clash` retain Full proof evidence for exact Plane/Cylinder solids without equating zero lower distance with interference. Parallel-cylinder CSG also Full-commits the manifold subset of exact unequal-radius internal radial tangency through positive axial overlap. Directed containment and one complete four-endpoint preorder let Intersect return the contained-radius overlap band or whole contained copy, covered-window Unite return the whole containing copy, and contained-minus-containing return regularized empty or one/two contained-radius bands. Atomic Full-valid 3F/2E/0V results retain complete DerivedFrom, ordered Face Split, and ordered dual-source cut-ring lineage without Merge. Deterministic outcomes cover rebuilt one/two-band, source-copy, proven-empty, and refusal modes across world/translated-Pythagorean direction/order/repeat matrices; every created result is Full-valid. Representative analytic-property, X_T/Fast self-import, rollback/replay, and exact 64/63 relation, 420/419 per-band, 840/839 two-band, 26/25 source-copy, and 3953/3952 property evidence close the slice. Evidence: `exact_internal_tangency_executes_the_regularized_axial_semantic_table`, `internal_tangency_realization_work_has_exact_atomic_frontiers`, and `rebuilt_internal_tangent_band_xt_is_stable_and_fast_self_imports_twice`. Unite requiring a tangent shoulder/shared tangent vertex and containing-minus-contained's pinched non-manifold annulus remain allocation-free typed topology refusals. Next: certify tangent-shoulder/shared-tangent-vertex Unite; keep containing-minus-contained typed non-manifold and skew SSI later.
