...
- Extend the landed deterministic-X_T axial, zero-cut whole-source/cavity, inverse-cavity, host-feature, two-port-hole, two-ring-union, and support-separated-contact block/cylinder slice to
