...
4. Extend the same ladder to block/cylinder (introduces curved SSI pcurves).
   *(active queue head — public cylinder construction, certified finite-cylinder
   ...
   identity, payload-agnostic exact boundary truth selection, and finite-cylinder
   ...
   emission and Fast self-import; mixed arc/ruling cycles, bounded-arc contacts/layouts,
   and curved licensed-host evidence remain)*
