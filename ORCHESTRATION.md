...
4. Extend the same ladder to block/cylinder (introduces curved SSI pcurves).
   *(active queue head — public cylinder construction, certified finite-cylinder
   ...
   first Full-checked axial intersection and cylinder-minus-block remainder bands
   now land through the public facade with deterministic X_T emission and Fast
   self-import; curved union, block-minus-cylinder mixed/cavity subtraction,
   broader contacts, and licensed-host evidence remain)*
