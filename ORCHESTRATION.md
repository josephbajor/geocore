...
4. Extend the same ladder to block/cylinder (introduces curved SSI pcurves).
   *(active queue head — public cylinder construction, certified finite-cylinder
   ...
   same scope without treating zero lower bounds as interference. Exact-parallel/antiparallel strict-secant Cylinder/Cylinder graph ruling proof is landed; public Section normalizes both authored boundary orders onto one certified common axial coordinate and closes each admitted strict positive overlap with two uniquely owned physical ends as one topology-owned component. Public partial-overlap Intersect Full-commits at 4F/6E/4V, both ordered Subtract meanings at 5F/7E/4V, and Unite at 6F/8E/4V through alternating periodic graph authority plus structural cap-reaching and two-host axial-chain shell theorems. The world/oblique, axis-direction, order, and repeat matrix has independent volume/area/centroid/inertia, direction-local deterministic X_T/Fast self-import, retained sources, whole-part rollback, and exact realization/property/shell N/N-1 refusal; unequal strict-secant radii and asymmetric tails validate general representation authority. Strict nesting shares the same axis-direction matrix and exact work contracts. Tangent, internal, coincident, and skew relations remain typed graph gaps. Proof-fed coincident planar-cap ownership now Full-commits equal-radius equal-height and one-shared-end parallel/antiparallel Cylinder/Cylinder Intersect, Unite, and both ordered Subtract meanings at 4F/6E/4V or 5F/7E/4V across world/oblique direction/order/repeat, with independent properties, journal lineage, deterministic X_T/Fast self-import, retained sources, rollback, and exact realization/property/shell N/N-1 refusal. Strict axial separation now binds all four live cap/ring supports, uses exact dyadic or Full-incidence-envelope authority, and precedes exterior radial evidence. Every public set operation shares one disjoint-source realization across secant, internal, tangent, coincident, and exterior radial supports: Intersect is mutation-free ProvenEmpty, Unite Full-commits canonical source copies, and ordered Subtract Full-commits the minuend copy with complete lineage, deterministic X_T/Fast self-import, retained sources, rollback, exact 64/63 relation work, and exact 52/26 realization-work refusal. Next: certify exact zero axial-gap cap contact for ProvenEmpty Intersect and minuend-copy Subtract; defer Unite until shared-interface removal is proof-owned.)*
