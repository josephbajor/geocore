...
//! degree-1 charts and canonical finite-open three-sample quadratic,
//! four-sample cubic, or seven-sample polyline charts between two direct
//! Offset(B-surface) roots.
