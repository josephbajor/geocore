...
//! and supported sheet bodies using analytic geometry and non-periodic
//! B-spline/NURBS curves or surfaces. Procedural and SP geometry, tolerant
//! entities, periodic NURBS, pre-13006 schemas, assemblies, and neutral-binary
//! writing remain deferred.
//!
//! Typical use:
//!
//! ```no_run
