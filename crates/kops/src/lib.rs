...
//! ellipse/plane, circle/cylinder, circle/cone, and circle/sphere. These cover
//! transverse and tangent contacts, periodic arc filtering, misses, and
//! oriented coincident overlaps. General
