...
//! ellipse/torus plus NURBS/plane and NURBS/sphere. These cover transverse and
...
//! initial marched plane/sphere/cylinder/cone/torus/NURBS-surface branches. General
