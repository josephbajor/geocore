...
//! These cover transverse and tangent contacts, periodic arc filtering,
//! misses, and oriented coincident overlaps. General NURBS/procedural
//! curve/curve, curve/surface, SSI, imprinting, and body operations remain
//! future M4 work.
