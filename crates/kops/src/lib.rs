...
//! ellipse/sphere, ellipse/cylinder, and ellipse/cone. These cover transverse
//! and tangent contacts, periodic arc filtering, misses, and oriented
//! coincident overlaps. General NURBS/procedural curve/curve, broader
