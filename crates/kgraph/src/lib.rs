...
pub use intersection::{
    ...
    TransmittedPlaneNurbsIntersectionCertificate, TransmittedPlaneNurbsTrace,
    TransmittedQuadraticInterpolationWitnesses, VerifiedIntersectionCarrier,
    ...
    VerifiedNurbsNurbsCertificateCost, VerifiedSphereNurbsCertificateCost,
