...
pub use section::{
    ...
    SectionFragmentSite, SectionGap, SectionIsolatedContact, SectionIsolatedContactRoot,
    SectionLoop, SectionPeriodicBoundaryRootEmbedding, SectionPeriodicBoundaryTraceEmbedding,
