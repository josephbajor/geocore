...
//! evaluation, certified convex-planar plus axial, zero-cut whole-source,
//! one-ring connected-union/blind-pocket, and two-port through-hole curved body
//! Booleans, and typed X_T import/export plus graph-owned bounded curve intersection
