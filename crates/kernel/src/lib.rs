...
pub use section::{
    ...
    SectionBoundedProceduralPhysicalRoot, SectionBoundedProceduralTrimProvenance, SectionBranch,
    SectionBranchEvidence, SectionBranchTopology, SectionCarrier, SectionCarrierParameterInterval,
    ...
    SectionCurveFragmentEnd, SectionCurveFragmentSpan, SectionCurveTrimProvenance,
    SectionCylinderCylinderExteriorRadialSeparation, SectionEdge, SectionEdgeParameterInterval,
    SectionFoldedSupportFragmentEnd, SectionFoldedSupportSheet, SectionFragmentSite, SectionGap,
    SectionIsolatedContact, SectionIsolatedContactKind, SectionIsolatedContactRoot, SectionLoop,
    ...
    SectionRulingFragmentEnd, SectionRulingTrimProvenance, SectionSite,
