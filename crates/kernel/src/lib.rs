...
//! evaluation, certified convex-planar plus first axial and zero-cut whole-source
//! curved body Booleans, and typed X_T import/export plus graph-owned bounded curve intersection with F2 reports
