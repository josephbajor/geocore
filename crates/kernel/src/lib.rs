...
pub use section::{
    ...
    SectionFragmentSite, SectionGap, SectionIsolatedContact, SectionIsolatedContactKind,
    SectionIsolatedContactRoot, SectionLoop, SectionPeriodicBoundaryRootEmbedding,
    SectionPeriodicBoundaryTraceEmbedding, SectionPeriodicComponentEmbedding,
